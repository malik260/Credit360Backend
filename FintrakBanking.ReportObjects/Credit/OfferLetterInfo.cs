            ...
            try
            {
                var loanDetails = (from a in context.TBL_LOAN_APPLICATION
                                   ...
                                   select new OfferLetterDetailViewModel()
                                   {
                                       ...
                                       //GetLoanApplicationFee(applicationRefNumber, b.LOANAPPLICATIONDETAILID)
                                   }).ToList();
                //var fees = (from df in context.TBL_LOAN_APPLICATION_DETL_FEE
                ...
                //            where la.APPLICATIONREFERENCENUMBER == applicationRefNumber 
