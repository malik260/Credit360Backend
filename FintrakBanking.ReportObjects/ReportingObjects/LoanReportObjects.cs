    ...
    public class LoanReportObjects
    {
        ...
        public List<Form3800BReportViewModel> Form3800BApprovedFacility(int companyId, DateTime startDate, DateTime endDate)
        {
            using (FinTrakBankingStagingContext stagecontext = new FinTrakBankingStagingContext())
            {
              ...
              var  termLoan = new List<Form3800BReportViewModel>();
              var  lmsTermLoan = new List<Form3800BReportViewModel>();
              var     lmsOD = new List<Form3800BReportViewModel>();
              var     lmsContingent = new List<Form3800BReportViewModel>();
                using (FinTrakBankingContext context = new FinTrakBankingContext())
                {
                ...
                return termLoan.Union(lmsTermLoan).Union(lmsOD).Union(lmsContingent).ToList();
            }
