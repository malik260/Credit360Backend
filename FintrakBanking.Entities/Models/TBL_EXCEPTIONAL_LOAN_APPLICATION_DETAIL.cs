...
{
    [Table("TBL_EXCEPTIONAL_LOAN_APPL_DETAIL")]
    public class TBL_EXCEPTIONAL_LOAN_APPL_DETAIL
    {
        public TBL_EXCEPTIONAL_LOAN_APPL_DETAIL()
        {
            TBL_EXCEPTIONAL_LOAN_APPL_DETL_FEE = new HashSet<TBL_EXCEPTIONAL_LOAN_APPL_DETL_FEE>();
        }
        ...
        public virtual TBL_EXCEPTIONAL_LOAN_APPLICATION TBL_EXCEPTIONAL_LOAN_APPLICATION { get; set; }
