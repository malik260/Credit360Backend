namespace FintrakBanking.Entities.Models
{
    ...
    [Table("TBL_LMSR_APPLICATION_COLLATRL2")]
    public partial class TBL_LMSR_APPLICATION_COLLATRL2
    {
        [Key]
        public int COLLATERALBASICDETAILID { get; set; }

        public int LOANAPPLICATIONID { get; set; } // redundant column!

        //public int? LOANREVIEWAPPLICATIONID { get; set; } // make nullable
