namespace FintrakBanking.Entities.SQLServerModel
{
    ...
    public partial class Model1 : DbContext
    {
        ...
        public virtual DbSet<TBL_STAFF_ACCOUNT_HISTORY_TYPE> TBL_STAFF_ACCOUNT_HISTORY_TYPE { get; set; }
        ...
        public virtual DbSet<TBL_LOAN_HISTORY> TBL_LOAN_HISTORY { get; set; }
        ...
        public virtual DbSet<TBL_LOAN_REVOLVING_HISTORY> TBL_LOAN_REVOLVING_HISTORY { get; set; }
        ...
        public virtual DbSet<TBL_CUSTOM_API_LOGS_TYPE> TBL_CUSTOM_API_LOGS_TYPE { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TBL_APPROVAL_GROUP>()
                .HasMany(e => e.TBL_TEMP_APPROVAL_LEVEL)
                .WithRequired(e => e.TBL_APPROVAL_GROUP)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_APPROVAL_GROUP>()
                .HasMany(e => e.TBL_TEMP_APPROVAL_GRP_MAPPING)
                .WithRequired(e => e.TBL_APPROVAL_GROUP)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_APPROVAL_LEVEL>()
                ...
                .WithOptional(e => e.TBL_APPROVAL_LEVEL1)
                .HasForeignKey(e => e.TRANCHEAPPROVAL_LEVELID);
            ...
            modelBuilder.Entity<TBL_APPROVAL_LEVEL>()
                .HasMany(e => e.TBL_TEMP_APPROVAL_LEVEL_STAFF)
                .WithRequired(e => e.TBL_APPROVAL_LEVEL)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_BRANCH>()
                .HasMany(e => e.TBL_LOAN_REVOLVING_HISTORY)
                .WithRequired(e => e.TBL_BRANCH)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_CHECKLIST_ITEM>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_DEFINITION)
                .WithRequired(e => e.TBL_CHECKLIST_ITEM)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_CHECKLIST_STATUS>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_DETAIL)
                .WithRequired(e => e.TBL_CHECKLIST_STATUS)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_COMPANY>()
                .HasMany(e => e.TBL_COMPANY_DIRECTOR)
                .WithRequired(e => e.TBL_COMPANY)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_COMPANY>()
                .HasMany(e => e.TBL_CRMS_REGULATORY)
                .WithRequired(e => e.TBL_COMPANY)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_COMPANY>()
                .HasMany(e => e.TBL_CRMS_TYPE)
                .WithRequired(e => e.TBL_COMPANY)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_COMPANY>()
                .HasMany(e => e.TBL_TEMP_LOAN_CAMSOL)
                .WithRequired(e => e.TBL_COMPANY)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_COMPANY_DIRECTOR>()
                .Property(e => e.ADDRESS)
                .IsUnicode(false);

            modelBuilder.Entity<TBL_COMPANY_DIRECTOR>()
                .HasMany(e => e.TBL_CUSTOMER_RELATED_PARTY)
                .WithRequired(e => e.TBL_COMPANY_DIRECTOR)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_CURRENCY>()
                .HasMany(e => e.TBL_LOAN1)
                .WithOptional(e => e.TBL_CURRENCY1)
                .HasForeignKey(e => e.NOSTROCURRENCYID);
            ...
            modelBuilder.Entity<TBL_CURRENCY_RATECODE>()
                .HasMany(e => e.TBL_LOAN)
                .WithOptional(e => e.TBL_CURRENCY_RATECODE)
                .HasForeignKey(e => e.NOSTRORATECODEID);
            ...
            modelBuilder.Entity<TBL_DOC_TEMPLATE>()
                .HasMany(e => e.TBL_DOC_TEMPLATE_SECTION)
                .WithRequired(e => e.TBL_DOC_TEMPLATE)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_DOC_TEMPLATE_SECTION>()
                .HasMany(e => e.TBL_DOC_TEMPLATE_DETAIL)
                .WithRequired(e => e.TBL_DOC_TEMPLATE_SECTION)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_DOC_TEMPLATE_SECTION>()
                .HasMany(e => e.TBL_DOC_TEMPLATE_SECTION_ROLE)
                .WithRequired(e => e.TBL_DOC_TEMPLATE_SECTION)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_PROFILE_USER>()
                .HasMany(e => e.TBL_PROFILE_PASSWORD_HISTORY)
                .WithRequired(e => e.TBL_PROFILE_USER)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_STAFF>()
                .HasMany(e => e.TBL_LOAN_REVOLVING_HISTORY1)
                .WithRequired(e => e.TBL_STAFF1)
                .HasForeignKey(e => e.RELATIONSHIPMANAGERID)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_STAFF>()
                .HasMany(e => e.TBL_STAFF_EXTENDED)
                .WithRequired(e => e.TBL_STAFF)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_STAFF_ACCOUNT_HISTORY_TYPE>()
                .HasMany(e => e.TBL_STAFF_ACCOUNT_HISTORY)
                .WithRequired(e => e.TBL_STAFF_ACCOUNT_HISTORY_TYPE)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_CRMS_TYPE>()
                .HasMany(e => e.TBL_CRMS_REGULATORY)
                .WithRequired(e => e.TBL_CRMS_TYPE)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_ESG_CATEGORY>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_DEFINITION)
                .WithRequired(e => e.TBL_ESG_CATEGORY)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_ESG_CATEGORY>()
                .HasMany(e => e.TBL_ESG_SUB_CATEGORY)
                .WithRequired(e => e.TBL_ESG_CATEGORY)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_ESG_CHECKLIST_DEFINITION>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_DETAIL)
                .WithRequired(e => e.TBL_ESG_CHECKLIST_DEFINITION)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_ESG_CLASS>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_DETAIL)
                .WithRequired(e => e.TBL_ESG_CLASS)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<TBL_ESG_TYPE>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_DETAIL)
                .WithRequired(e => e.TBL_ESG_TYPE)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_LOAN>()
                .Property(e => e.NOSTRORATEAMOUNT)
                .HasPrecision(19, 4);

            modelBuilder.Entity<TBL_LOAN>()
                .HasMany(e => e.TBL_LOAN_DISBURSEMENT)
            ...
            modelBuilder.Entity<TBL_LOAN_APPLICATION>()
                .HasMany(e => e.TBL_LOAN_APPLICATION_COLT2_LOG)
                .WithRequired(e => e.TBL_LOAN_APPLICATION)
            ...
            modelBuilder.Entity<TBL_LOAN_APPLICATION>()
                .HasMany(e => e.TBL_LOAN_APPLICATION_COLT2_LOG1)
                .WithRequired(e => e.TBL_LOAN_APPLICATION1)
                .HasForeignKey(e => e.LOANAPPLICATIONID)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_LOAN_APPLICATION_COLT2_LOG>()
                .Property(e => e.COLLATERALVALUE)
                .HasPrecision(19, 4);
            ...
            modelBuilder.Entity<TBL_LOAN_APPLICATION_DETAIL>()
                .HasMany(e => e.TBL_ESG_CHECKLIST_SUMMARY)
                .WithRequired(e => e.TBL_LOAN_APPLICATION_DETAIL)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_LOAN_APPLICATION_DETAIL>()
                .HasMany(e => e.TBL_LOAN_APPLICATION_COLT2_LOG)
                .WithOptional(e => e.TBL_LOAN_APPLICATION_DETAIL)
                .HasForeignKey(e => e.LOANAPPLICATIONDETAILID);

            modelBuilder.Entity<TBL_LOAN_APPLICATION_DETAIL>()
                .HasMany(e => e.TBL_LOAN_APPLICATION_COLT2_LOG1)
                .WithOptional(e => e.TBL_LOAN_APPLICATION_DETAIL1)
                .HasForeignKey(e => e.LOANAPPLICATIONDETAILID);
            ...
            modelBuilder.Entity<TBL_LOAN_CAMSOL>()
                .Property(e => e.INTERESTINSUSPENSE)
                .HasPrecision(19, 4);

            modelBuilder.Entity<TBL_LOAN_CAMSOL_TYPE>()
                .HasMany(e => e.TBL_LOAN_CAMSOL)
                .WithRequired(e => e.TBL_LOAN_CAMSOL_TYPE)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_LOAN_DISBURSEMENT>()
                .Property(e => e.AMOUNTDISBURSED)
                .HasPrecision(19, 4);
            ...
            modelBuilder.Entity<TBL_LOAN_HISTORY>()
                .Property(e => e.TEAMMISCODE)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TBL_LOAN_PRUDENTIALGUIDELINE>()
                .HasMany(e => e.TBL_LOAN_REVOLVING_HISTORY2)
                .WithRequired(e => e.TBL_LOAN_PRUDENTIALGUIDELINE2)
                .HasForeignKey(e => e.USER_PRUDENTIAL_GUIDE_STATUSID)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TBL_LOAN_REVOLVING_HISTORY>()
                .Property(e => e.TEAMMISCODE)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TBL_CUSTOM_TRANSACTION_BULK>()
                .Property(e => e.AMOUNT)
                .HasPrecision(19, 4);
            ...
            modelBuilder.Entity<TBL_CUSTOM_TRANSACTION_BULK>()
                .Property(e => e.FORCEDEBITACCOUNT)
                .IsFixedLength()
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TBL_TEMP_APPROVAL_LEVEL>()
                .Property(e => e.MAXIMUMAMOUNT)
                .HasPrecision(19, 4);
            ...
            modelBuilder.Entity<TBL_TEMP_APPROVAL_LEVEL_STAFF>()
                .Property(e => e.MAXIMUMAMOUNT)
                .HasPrecision(19, 4);
            ...
            modelBuilder.Entity<TBL_TEMP_LOAN_CAMSOL>()
                .Property(e => e.BALANCE)
                .HasPrecision(19, 4);
