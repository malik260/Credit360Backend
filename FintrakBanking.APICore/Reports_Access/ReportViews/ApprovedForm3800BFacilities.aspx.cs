...
{
    public partial class ApprovedForm3800BFacilities : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    string searchInfo = Request.QueryString["searchInfo"];
                    ...
                    LoanReportObjects loanReportObjects = new LoanReportObjects();
                    var data = loanReportObjects.Form3800BApprovedFacility(companyId, startDate, endDate);
                    ...
                    reportDataSource.Name = "Form3800B";

                    this.ReportViewer.LocalReport.DataSources.Add(reportDataSource);
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/Form3800BFacilityReport.rdlc");
                    this.ReportViewer.LocalReport.Refresh();
                }
                catch (Exception ex)
                {
