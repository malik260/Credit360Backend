...
{
    public partial class CbnNplTeamReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ReportViewer.ServerReport.ReportPath = reportPath + "Cbn Npl Team"; // string.Format(reportPath, "Risk Asset");
