...
{
    public partial class UserGroupChangeReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    StaffModifiedInformationReport userGroupChangeReport = new StaffModifiedInformationReport();
                    var data = userGroupChangeReport.UserGroupChangeReport(startDate, endDate, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "UserGroupChangeReport";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/UserGroupChangeReport.rdlc");
