...
{
    public partial class StaffPriviledgeChangeReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    StaffModifiedInformationReport staffInformationReport = new StaffModifiedInformationReport();
                    var data = staffInformationReport.StaffPrivilegeChange(startDate,endDate,companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "StaffInfoDataSet";
                 ...
                 //   ReportParameter sDate = new ReportParameter("startDate", startDate.ToString());
                  //  ReportParameter eDate = new ReportParameter("endDate", endDate.ToString());
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/StaffPrivilegeChangeReport.rdlc");
