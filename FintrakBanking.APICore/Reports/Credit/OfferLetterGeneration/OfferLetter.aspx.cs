...
namespace FintrakBanking.APICore.Reports.Credit.OfferLetterGeneration
{
    public partial class OfferLetter : System.Web.UI.Page
    {
        ...
        void GenerateOutPutDocument(string applicationRefNumber)
        {
            ...
            var contractCode = offerLetter.GetLoanApplicationContractCode(applicationRefNumber);
            ReportDataSource dsContractCode = new ReportDataSource();
            dsContractCode.Value = contractCode;
            dsContractCode.Name = "OfferLetterContractCode";
            ...
            offerLetterReport.LocalReport.DataSources.Add(dsContractCode);
            ...
            foreach (var x in loanApplicationDetail)
            {
                ...
                {
                    reportLink = Server.MapPath("~/Reports/Credit/OfferLetterGeneration/OfferLetterAll4one.rdlc");
                }
                else
                {
                    reportLink = Server.MapPath("~/Reports/Credit/OfferLetterGeneration/OfferLetter.rdlc");
