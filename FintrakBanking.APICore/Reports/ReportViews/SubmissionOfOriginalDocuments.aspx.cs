...
{
    public partial class SubmissionOfOriginalDocuments : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var data = reportObjects.SubmissionOfOriginalDocuments(startDate, endDate, referenceNumber);
                ...
                reportDataSource.Name = "SubmissionOfOriginalDocuments";
