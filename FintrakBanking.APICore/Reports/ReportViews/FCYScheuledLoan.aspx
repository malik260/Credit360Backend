<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FCYScheuledLoan.aspx.cs" Inherits="FintrakBanking.APICore.Reports.ReportViews.FCYScheuledLoan" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer KeepSessionAlive="false" ID="ReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" WaitMessageFont-Names="Verdana" 
            ...
            <LocalReport ReportPath="Reports\Report\FCYScheuledLoan.rdlc" >
                
                <datasources>
                          <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="FCYScheuledLoan" />
                      </datasources>
            </LocalReport>
        </rsweb:ReportViewer>
     
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FCYScheuledLoan" TypeName="FintrakBanking.ReportObjects.LoanReportObjects">
            <SelectParameters> 
