...
{
    public partial class ProfileActivityReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    StaffModifiedInformationReport profileActivityReport = new StaffModifiedInformationReport();
                    var data = profileActivityReport.ProfileActivityReport(startDate, endDate, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "ProfileActivityReport";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/ProfileActivityReport.rdlc");
