...
{
    public partial class SanctionLimitReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    LoanReportObjects sanctionLimitReport = new LoanReportObjects();
                    var data = sanctionLimitReport.SanctionLimitReport(startDate, endDate, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "SanctionLimitReport";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/SanctionLimitReport.rdlc");
