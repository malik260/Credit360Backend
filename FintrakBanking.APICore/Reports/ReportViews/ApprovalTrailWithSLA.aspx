<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovalTrailWithSLA.aspx.cs" Inherits="FintrakBanking.APICore.Reports.Credit.ApprovalTrailWithSLA" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="operationId" runat="server" ></asp:Label>
        <asp:Label ID="targetId" runat="server" ></asp:Label>
