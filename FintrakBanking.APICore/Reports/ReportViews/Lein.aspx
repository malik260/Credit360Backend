<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lein.aspx.cs" Inherits="FintrakBanking.APICore.Reports.ReportViews.LoanCASAaccountWithLein" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" WaitMessageFont-Names="Verdana" 
            ...
            <LocalReport ReportPath="Reports\Report\Lein.rdlc" >
                
                <datasources>
                          <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="LeinLoanCASA" />
                      </datasources>
            </LocalReport>
        </rsweb:ReportViewer>
     
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="AccountsWithLein" TypeName="FintrakBanking.ReportObjects.LoanReportObjects" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
