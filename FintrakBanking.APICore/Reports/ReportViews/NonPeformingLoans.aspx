...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="nplLoanRv" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="685px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1100px">
            <LocalReport ReportPath="Reports\Report\NonPeformingLoans.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="odsNplLoan" runat="server" SelectMethod="NPL" TypeName="FintrakBanking.ReportObjects.ReportingObjects.LimitsMonitoringReportsObjects">
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="classification" Name="classification" PropertyName="Text" Type="Int32" />
            </SelectParameters>
