<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanStatement.aspx.cs" Inherits="FintrakBanking.APICore.Reports.ReportViews.LoanStatement" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" WaitMessageFont-Names="Verdana" 
            ...
            <LocalReport ReportPath="Reports\Report\LoanStatement.rdlc" >
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="LoanStatement" TypeName="FintrakBanking.ReportObjects.LoanReportObjects">
            <SelectParameters> 
