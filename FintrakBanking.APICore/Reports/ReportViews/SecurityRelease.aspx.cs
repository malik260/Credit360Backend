...
{
    //public partial class SecurityRelease : System.Web.UI.Page
    //{
    ...
    //                    return;
    //                }
    //                LoanReportObjects SecurityRelease = new LoanReportObjects();
    //               var data = SecurityRelease.SecurityRelease(startDate, endDate, status, companyId);

    //                this.ReportViewer.LocalReport.DataSources.Clear();
    //                ReportDataSource reportDataSource = new ReportDataSource();
    //                reportDataSource.Value = data;
    //                reportDataSource.Name = "SecurityRelease";
    ...
    //                this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/SecurityRelease.rdlc");
