...
{
    public partial class AvailmentUtilizationTicket : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    LoanReportObjects loanReport = new LoanReportObjects();
                    var data = loanReport.AvailmentUtilizationTicket(customerId);
                    var Conditions = loanReport.GetConditionPrecedents();
                    ...
                    ReportDataSource ConditionSource = new ReportDataSource("DataSet2", Conditions);
                    ...
                    this.ReportViewer.LocalReport.DataSources.Add(ConditionSource);
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/AvailmentUtilizationTicketReport.rdlc");
