...
namespace FintrakBanking.ViewModels.Setups.General
{
    ...
    public class TotalExposureLimit
    {
        ...
        public string SectorLimitString
        {
            get
            {
                if (SectorMaximumExposure == 0) return "No limit";
        ...
        public string AccountOfficerNPLLimitString
        {
            get
            {
                if (AccountOfficerMaximumNPLExposure == 0) return "No limit";
        ...
        public string BranchNPLLimitString
        {
            get
            {
                if (BranchMaximumNPLExposure == 0) return "No limit";
        ...
        public string ObligorLimitString
        {
            get
            {
                if (ObligorExposure == 0) return "No limit";
