...
namespace FintrakBanking.Repositories.Setups.General
{
    ...
    public class StaffRoleRepository00 : IStaffRoleRepository00
    {
        ...
        public StaffRoleRepository00(FinTrakBankingContext _context, IAuditTrailRepository _auditTrail,
        ...
        public IEnumerable<StaffRoleViewModel> GetStaffRoleByCompanyId(int companyId)
        {
            return from a in context.TBL_STAFF_ROLE
                   ...
                   select new StaffRoleViewModel
                   {
                       ...
                       workEndDuration = a.WORKENDDURATION,
                       workStartDuration = a.WORKSTARTDURATION,
                       userGroup = a.TBL_PROFILE_STAFF_ROLE_GROUP.Where(x => x.STAFFROLEID == a.STAFFROLEID).Select(x => new UserGroup
                       {
                           groupId = x.GROUPID,
                       ...
                       //}).ToList()
                       activities = a.TBL_PROFILE_STAFF_ROLE_ADT_ACT.Where(x => x.STAFFROLEID == a.STAFFROLEID).Select(d => new UserActivities
                       {
                           activityId = d.ACTIVITYID,
                           userId = d.STAFFROLEID,
                           activityName = d.TBL_PROFILE_ACTIVITY.ACTIVITYNAME
        ...
        public bool AddUpdateStaffRole(StaffRoleViewModel entity)
        {
                ...
                if (entity != null)
                {
                    try
                    {
                        ...
                        {
                            staffRole = context.TBL_STAFF_ROLE.Where(o=>o.STAFFROLEID == entity.staffRoleId).FirstOrDefault();
                        ...
                        using (var trans = context.Database.BeginTransaction())
                        {
                            try
                            {
                              ...
                              //  workFlow.SendEmailByRoleId = true;
