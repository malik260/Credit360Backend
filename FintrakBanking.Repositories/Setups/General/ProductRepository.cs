                ...
                try
                {
                    ...
                    if (workFlow.NewState == (int)ApprovalState.Ended )
                    {
                        if(workFlow.StatusId == (int)ApprovalStatusEnum.Approved)
                        {
                            ...
                            context.SaveChanges();
                            loanOperations.ProcessGlobalInterestRepricing(globalPriceIndex.EFFECTIVEDATE, globalPriceIndex.PRODUCTPRICEINDEXID, (short)entity.createdBy, (int)globalPriceIndex.ISMARKETINDUCED, globalPriceIndex.PRODUCTPRICEINDEXGLOBALID);
                            trans.Commit();
                            return 1;
