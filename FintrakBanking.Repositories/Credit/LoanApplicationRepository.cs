        ...
        public IEnumerable<ExistingLoanApplicationViewModel> ExistingLoanApplication(int customerId, int companyId)
        {
            var data = context.tbl_Loan_Application.Where(c => c.CustomerId == customerId && c.CompanyId == companyId)
                .Select(c => new ExistingLoanApplicationViewModel()
                {
                    ...
                    //TODO refactor              principalAmount = c.PrincipalAmount,
                    //TODO refactor              tenor = c.Tenor
                }).ToList();
            return data;
        }
      ...
      //TODO refactor                      tenor = a.Tenor,
        ...
        public async Task<bool> AddLoanApplication(LoanApplicationViewModel loan)
        {
            ...
            var data = new tbl_Loan_Application
            {
                ...
                //TODO refactor          Tenor = loan.tenor,
                ...
                //TODO refactor     ProductId = loan.productId,
                //TODO refactor          PrincipalAmount = loan.principalAmount,
                ApplicationDate = genSetup.GetApplicationDate(),
                LoanInformation = loan.loanInformation,
                IsRelatedParty = loan.isRealatedParty,
            ...
            // application goes for approval. maybe needed in future
                ...
                return context.tbl_Loan_Application.Where(x => x.CompanyId == companyId && x.Deleted == false //&& x.BranchId == branchId
                    ...
                    .SelectMany(
                        ...
                        (x, y) => new LoanApplicationViewModel
                        {
                            ...
                            //TODO refactor                      productClassId = x.a.tbl_Product.ProductClassId,
                            ...
                            //TODO refactor currencyId = x.a.CurrencyId,
                            ...
                            //TODO refactor                     principalAmount = x.a.PrincipalAmount,
                            interestRate = x.a.InterestRate,
                            //TODO refactor                      tenor = x.a.Tenor,
                            ...
                            isRealatedParty = x.a.IsRelatedParty,
