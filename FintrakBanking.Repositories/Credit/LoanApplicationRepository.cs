...
namespace FintrakBanking.Repositories.Credit
{
    public partial class LoanApplicationRepository : ILoanApplicationRepository
    {
        ...
        public bool IncomingLoanApplicationApproval(HeadOfficeFacilityApprovalViewModel model)
        {
            bool ststus = false;
            if (model != null)
            {
                var basicTransaction = new STG_SUB_BASICTRANSACTION()
                {
                ...
                scontext.STG_SUB_BASICTRANSACTION.Add(basicTransaction);
                ststus = scontext.SaveChanges() > 0;
            }
            return ststus;
        }
