...
namespace FintrakBanking.Repositories.Credit
{
    public class CreditDrawdownRepository : ICreditDrawdownRepository
    {
        ...
        private bool AddLoanBookingRequests(int applicationStatusId, LoanBookingRequestViewModel entity)
        {
            ...
            if (context.TBL_LOAN_BOOKING_REQUEST.Any(x => x.LOANAPPLICATIONDETAILID == entity.loanApplicationDetailId && x.CUSTOMERID == entity.customerId && (x.APPROVALSTATUSID != (short)ApprovalStatusEnum.Approved && x.ISUSED == false) && (x.APPROVALSTATUSID != (short)ApprovalStatusEnum.Disapproved) && x.DELETED == false))
            {
