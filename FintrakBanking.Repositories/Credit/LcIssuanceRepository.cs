...
namespace FintrakBanking.Repositories.credit
{
    public class LcIssuanceRepository : ILcIssuanceRepository
    {
        ...
        public List<LcIssuanceApprovalViewModel> SearchLc(string searchString)
        {
            ...
            int[] currentApprovalLevelStatuses = { (int)LoanApplicationStatusEnum.LcIssuanceInProgress, (int)LoanApplicationStatusEnum .LcIssuanceCompleted,
                                                        (int)LoanApplicationStatusEnum.LcShippingReleaseInProgress, (int)LoanApplicationStatusEnum.LcShippingReleaseCompleted};
                ...
                var applications = (from x in context.TBL_LC_ISSUANCE
                                    ...
                                    from res in xz.DefaultIfEmpty() 
                                    join z2 in context.TBL_APPROVAL_TRAIL on res.LCRELEASEAMOUNTID equals z2.TARGETID into resz2
                                    where 
                            ...
                            || x.LCISSUANCEID.ToString().Contains(searchString)
                                    ...
                                    from final in resz2.DefaultIfEmpty() select new LcIssuanceApprovalViewModel
                                    {
                                        ...
                                        UsanceCurrentApprovalLevel = (y.OPERATIONID == (int)OperationsEnum.lcUssance && y.TOAPPROVALLEVELID != null) ? context.TBL_APPROVAL_LEVEL.FirstOrDefault(s => s.APPROVALLEVELID == y.TOAPPROVALLEVELID).LEVELNAME : "n/a",
                                    ...
                                    }).GroupBy(a => a.lcReferenceNumber).Select(g => g.OrderByDescending(l => l.approvalTrailId).FirstOrDefault());
            foreach (var app in applications)
            {
                ...
                //app.applicationStatusId = VerifyApplicationStatus(app.lcIssuanceId, app.operationId);
            }
        ...
        public short? VerifyApprovalLevelId(int lcIssuanceId, int operationId)
        {
            ...
            //{|| operationId == (int)OperationsEnum.lcReleaseOfShippingDocuments
            //    return lc.;
            //}
            //if (operationId == (int)OperationsEnum.lcUssance)
            //{
